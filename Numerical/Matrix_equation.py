...
Y=[D+Py*Macaulay(L-(x2+xa/2)),  #Mz(L)=0
   ...
   Pz/(E*Iyy)*1/6*Macauley(x2-xa/2-(x2+xa/2))**3+ DTd/(G*J)*(ha/2) - (0-zshear)/(G*J)*(ha/2)*Py*Macauley(x2-xa/2-(x2+xa/2))**1 + ha/(2*G*J)*ha/2*Pz*Macauley(x2-xa/2-(x2+xa/2))**1,       #w(x-xa/2)+twist(x-xa/2)*ha/2=0 at ACTUATOR 1
   0]          #Ay - Aztan(30) = 0
'''
